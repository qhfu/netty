...
#include <arpa/inet.h>
#include <fcntl.h>
#include "io_netty_jni_internal_Native.h"
...
JNIEXPORT void JNICALL Java_io_netty_jni_internal_Native_freeDirectBuffer(JNIEnv * env, jclass clazz, jobject jbuffer){
...
JNIEXPORT jint JNICALL Java_io_netty_jni_internal_Native_eventFd(JNIEnv * env, jclass clazz) {
...
JNIEXPORT void JNICALL Java_io_netty_jni_internal_Native_eventFdRead(JNIEnv * env, jclass clazz, jint fd) {
    uint64_t eventfd_t;
...
JNIEXPORT jint JNICALL Java_io_netty_jni_internal_Native_epollCreate(JNIEnv * env, jclass clazz) {
...
JNIEXPORT void JNICALL Java_io_netty_jni_internal_Native_epollCtlAdd(JNIEnv * env, jclass clazz, jint efd, jint fd, jint flags, jint id) {
...
JNIEXPORT void JNICALL Java_io_netty_jni_internal_Native_epollCtlMod(JNIEnv * env, jclass clazz, jint efd, jint fd, jint flags, jint id) {
...
JNIEXPORT void JNICALL Java_io_netty_jni_internal_Native_epollCtlDel(JNIEnv * env, jclass clazz, jint efd, jint fd) {
...
JNIEXPORT jint JNICALL Java_io_netty_jni_internal_Native_write(JNIEnv * env, jclass clazz, jint fd, jobject jbuffer, jint pos, jint limit) {
...
JNIEXPORT jint JNICALL Java_io_netty_jni_internal_Native_read(JNIEnv * env, jclass clazz, jint fd, jobject jbuffer, jint pos, jint limit) {
    // TODO: We could also maybe pass the address in directly and so eliminate this call
    //       not sure if this would buy us much. So some testing is needed.
    void *buffer = (*env)->GetDirectBufferAddress(env, jbuffer);
    if (buffer == NULL) {
...
JNIEXPORT void JNICALL Java_io_netty_jni_internal_Native_shutdown(JNIEnv * env, jclass clazz, jint fd, jboolean read, jboolean write) {
    int mode;
    if (read && write) {
        mode = SHUT_RDWR;
    } else if (read) {
...
JNIEXPORT void JNICALL Java_io_netty_jni_internal_Native_bind(JNIEnv * env, jclass clazz, jint fd, jbyteArray address, jint scopeId, jint port) {
...
JNIEXPORT void JNICALL Java_io_netty_jni_internal_Native_listen(JNIEnv * env, jclass clazz, jint fd, jint backlog) {
...
JNIEXPORT jboolean JNICALL Java_io_netty_jni_internal_Native_connect(JNIEnv * env, jclass clazz, jint fd, jbyteArray address, jint scopeId, jint port) {
    struct sockaddr_storage addr;
    init_sockaddr(env, address, scopeId, port, &addr);
...
JNIEXPORT void JNICALL Java_io_netty_jni_internal_Native_finishConnect(JNIEnv * env, jclass clazz, jint fd) {
...
JNIEXPORT jint JNICALL Java_io_netty_jni_internal_Native_accept(JNIEnv * env, jclass clazz, jint fd) {
    jint socketFd;
    int err;
...
JNIEXPORT jlong JNICALL Java_io_netty_jni_internal_Native_sendfile(JNIEnv *env, jclass clazz, jint fd, jobject fileRegion, jlong off, jlong len) {
...
JNIEXPORT jobject JNICALL Java_io_netty_jni_internal_Native_remoteAddress(JNIEnv * env, jclass clazz, jint fd) {
    socklen_t len;
    struct sockaddr_storage addr;
...
JNIEXPORT jobject JNICALL Java_io_netty_jni_internal_Native_localAddress(JNIEnv * env, jclass clazz, jint fd) {
    socklen_t len;
    struct sockaddr_storage addr;
...
JNIEXPORT void JNICALL Java_io_netty_jni_internal_Native_setReuseAddress(JNIEnv * env, jclass clazz, jint fd, jint optval) {
    setOption(env, fd, SOL_SOCKET, SO_REUSEADDR, &optval, sizeof(optval));
}

JNIEXPORT void JNICALL Java_io_netty_jni_internal_Native_setTcpNoDelay(JNIEnv *env, jclass clazz, jint fd, jint optval) {
    setOption(env, fd, IPPROTO_TCP, TCP_NODELAY, &optval, sizeof(optval));
}

JNIEXPORT void JNICALL Java_io_netty_jni_internal_Native_setReceiveBufferSize(JNIEnv *env, jclass clazz, jint fd, jint optval) {
    setOption(env, fd, SOL_SOCKET, SO_RCVBUF, &optval, sizeof(optval));
}

JNIEXPORT void JNICALL Java_io_netty_jni_internal_Native_setSendBufferSize(JNIEnv *env, jclass clazz, jint fd, jint optval) {
    setOption(env, fd, SOL_SOCKET, SO_SNDBUF, &optval, sizeof(optval));
}

JNIEXPORT void JNICALL Java_io_netty_jni_internal_Native_setKeepAlive(JNIEnv *env, jclass clazz, jint fd, jint optval) {
    setOption(env, fd, SOL_SOCKET, SO_KEEPALIVE, &optval, sizeof(optval));
}

JNIEXPORT void JNICALL Java_io_netty_jni_internal_Native_setTCPCork(JNIEnv *env, jclass clazz, jint fd, jint optval) {
    setOption(env, fd, SOL_TCP, TCP_CORK, &optval, sizeof(optval));
}

JNIEXPORT void JNICALL Java_io_netty_jni_internal_Native_setSoLinger(JNIEnv *env, jclass clazz, jint fd, jint optval) {
...
JNIEXPORT jint JNICALL Java_io_netty_jni_internal_Native_isReuseAddresss(JNIEnv *env, jclass clazz, jint fd) {
    int optval;
...
JNIEXPORT jint JNICALL Java_io_netty_jni_internal_Native_isTcpNoDelay(JNIEnv *env, jclass clazz, jint fd) {
    int optval;
...
JNIEXPORT jint JNICALL Java_io_netty_jni_internal_Native_getReceiveBufferSize(JNIEnv * env, jclass clazz, jint fd) {
    int optval;
...
JNIEXPORT jint JNICALL Java_io_netty_jni_internal_Native_getSendBufferSize(JNIEnv *env, jclass clazz, jint fd) {
    int optval;
...
JNIEXPORT jint JNICALL Java_io_netty_jni_internal_Native_isTcpCork(JNIEnv *env, jclass clazz, jint fd) {
    int optval;
...
JNIEXPORT jint JNICALL Java_io_netty_jni_internal_Native_getSoLinger(JNIEnv *env, jclass clazz, jint fd) {
